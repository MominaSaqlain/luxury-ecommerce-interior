...
function FeaturedCollections() {
  ...
  return (
py-24 lg:py-32 bg-gradient-to-b from-softCream to-white/50
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-2xl lg:text-3xl text-forestGreen/70 max-w-3xl mx-auto font-light">
            Our signature collections designed for modern luxury living
          </p>
        </motion.div>
        ...
        >
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {[...Array(8)].map((_, i) => (
                <div key={i} className="aspect-[4/3] bg-beige/20 animate-pulse rounded-3xl" />
              ))}
            </div>
          ) : (
        ...
        >
          <Link
            to="/collections"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-gold to-beige text-forestGreen px-12 py-6 lg:px-16 lg:py-8 rounded-3xl font-serif text-2xl lg:text-3xl font-medium uppercase tracking-wide shadow-2xl hover:shadow-glow-lg hover:scale-[1.02] ring-2 ring-gold/20 hover:ring-gold/50 transition-all duration-700 group shadow-xl"
          >
